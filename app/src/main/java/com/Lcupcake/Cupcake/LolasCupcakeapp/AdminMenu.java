...
public class AdminMenu extends Activity implements View.OnClickListener, SearchView.OnQueryTextListener, SearchView.OnSuggestionListener, SearchView.OnCloseListener, ListView.OnItemClickListener  {
    ...
    // method is used to set item click listener to the layout items
    @Override
    ...
    //calculates the sampleSize required of the image by using the requiredHeight and requiredWidth that we provide
    ...
    //this listener will fire when the text changes
    @Override
    ...
    //this method is fired when click an item from the search suggestions meny
    @Override
    ...
    //this method will run when close the search view in the activity
    @Override
